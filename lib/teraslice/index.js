...
const assetStore = require('teraslice/lib/cluster/storage/assets');
const stateStore = require('teraslice/lib/cluster/storage/state');
const analyticsStore = require('teraslice/lib/cluster/storage/analytics');
const opRunner = require('teraslice/lib/cluster/runners/op');
