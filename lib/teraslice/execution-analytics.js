...
class ExecutionAnalytics {
    constructor(context, config, messenger) {
        validateConfig(config);
        this.logger = makeLogger(context, config, 'execution_analytics');
    ...
    _pushAnalytics() {
        ...
        // FIXME: this.clusterMaster.updateAnalytics({ kind: 'slicer', stats: diffs });
