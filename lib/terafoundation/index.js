...
const validateExecutionContexts = require('terafoundation/lib/validate_configs');
...
function makeContext(cluster, config, sysconfig, useDebugLogger) {
    ...
    context.sysconfig = validateExecutionContexts(cluster, config, sysconfig);
