...
class MessageEmitter extends EventEmitter {
    ...
    on(eventName, fn) {
        ...
        if (results.length) console.log('on got cache', eventName, results);
    ...
    once(eventName, fn) {
        ...
        if (results.length) console.log('once got cache', eventName, results);
    ...
    onceWithTimeout(eventName, timeoutMs) {
