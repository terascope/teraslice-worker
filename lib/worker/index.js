...
/**
 * Teraslice Worker, assignment type "worker"
 * @export
 * @class Worker
 ...
 * @param {number} config.slicer_port  slicer port to connect to
...
class Worker {
    constructor(context, config, useExecutionRunner = false) {
        validateConfig(config);
        const workerId = generateWorkerId(context);
        const logger = makeLogger(context, config, 'worker');
        ...
        const networkerLatencyBuffer = _.get(context, 'sysconfig.teraslice.network_latency_buffer');
        ...
        this.slice = new Slice(context, config);
