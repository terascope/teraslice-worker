...
class Slice {
    constructor(context, config) {
        ...
        this.config = config;
        this.analytics = get(config, 'job.analytics', false);
    ...
    initialize(executionContext, slice, stores) {
        const { slice_id: sliceId } = slice;
        const { queue } = executionContext;
        ...
        this.logger = makeLogger(this.context, this.config, 'slice', { slice_id: sliceId });
    }
