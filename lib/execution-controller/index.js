...
const { recovery, sliceAnalytics } = executionController;
...
class ExecutionController {
    ...
    async initialize() {
        ...
        const stateStore = storage.state(context);
        const exStore = storage.execution(context);
    ...
    async run() {
        ...
        this.slicerAnalytics = sliceAnalytics(context, executionContext);
    ...
    async slicerCompleted() {
        ...
        this.executionAnalytics.set('queuing_complete', utils.date.newFormattedDate());
    }
