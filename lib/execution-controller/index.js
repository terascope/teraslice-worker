...
class ExecutionController {
    constructor(context, executionContext) {
        ...
        const networkLatencyBuffer = get(context, 'sysconfig.teraslice.network_latency_buffer');
        ...
        this.clusterMasterClient = new ClusterMasterClient({
            ...
            executionContext,
            hostname: get(context, 'sysconfig.teraslice.hostname'),
            workerId,
            networkLatencyBuffer,
            actionTimeout,
        });
    ...
    isDone() {
        ...
        if (this.stopProcessing) return true;
